...
class ProductStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'wholesale_price' => 'required_if:elwekala_policy,1|numeric|min:0',
            'consumer_price' => 'required|numeric|min:0',
            'profit_percentage' => 'required_if:elwekala_policy,1|numeric|min:0',
            ...
            'publish_date' => 'nullable|date|required_if:publish_type,false',
        ];
